...
This page is for potential contributors to the OSCAL project's oscal-deep-diff subproject. It provides basic information on the OSCAL project, describes the main ways people can make contributions, explains how to report issues with OSCAL, and lists pointers to additional sources of information.
...
*Note that the main OSCAL repository's projects are still used to track oscal-deep-diff progress through tracker tickets.*
...
- [.circleci/](.circleci): Contains CI/CD configuration.
...
- [bin/](bin): Contains node executable entrypoints for oscal-deep-diff CLI.
